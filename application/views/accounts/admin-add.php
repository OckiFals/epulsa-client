...
?>
<?php $this->load->view('header', ['title' => 'Tambah Akun Admin']) ?>
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="alert alert-info alert-dismissable" id="flash-message-success" style="display: none">
                ...
                <div id="errors-list">
                    Akun dengan username <strong><span id="success-message"></span></strong> berhasil ditambahkan.
                </div>
            </div>
            <!-- /flash message success -->
                        ...
                        <div class="box box-info" id="contentData">
                            ...
                            <div class="box-body">
                                <div class="register-box-body">
                                    <p class="login-box-msg">Daftarkan Akun Admin Baru</p>
                                    ...
                                    <form action="" method="POST" id="register-form" novalidate="novalidate">
                                        ...
                                        <div class="row">
                                            ...
                                            <!-- /.col -->
                                            <div class="col-xs-4">
                                                <button class="btn btn-primary btn-block btn-flat">Tambah
                                                </button>
                                            </div>
                                            <!-- /.col -->
                                        </div>
