 ...
 */
?>
<?php $this->load->view('header', ['title' => 'Kelola Akun Konter']) ?>
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active"><i class="fa fa-users"></i> Semua Konter</li>
            </ol>
        </section>
                    ...
                    <div id="contentHolder">
                        <div class="box box-info" id="contentData">
                            <div class="box-header with-border">
                                <h3 class="box-title">Semua KOnter</h3>

                                <div class="box-tools pull-right">
                                    <a href="<?php echo base_url('account/counter/add') ?>" class="btn btn-info btn-sm btn-flat"
                                       rel="tab">
                                        <i class="fa fa-plus"></i> Tambah KOnter
                                    </a>
                                </div>
                            </div>
                            <!-- /.box-header -->
    ...
    <script type="application/javascript">
        $(document).ready(function () {
            ...
            $.ajax({
                url: "http://localhost:8080/user/counter/",
                type: "GET",
                dataType: "json",
                headers: {
                    ...
                    window.setTimeout(function () {
                        $.each(data, function (index, obj) {
                            account_table.row.add([
                                // col 1
                                ' <span id="account-' + obj.user.id + '" style="text-align: center" class="center-block">' + obj.user.id + '</span> ',
                                // col 2
                                obj.user.username,
                                // col 3
                                obj.store_name,
                                ...
                                obj.address,
                                // col 5
                                ' <a href="admin/edit/' + obj.user.id + 
                                '" class="btn btn-xs btn-flat btn-primary"> ' +
                                ' <i class="fa fa-edit "></i> Ubah ' +
                                ' </a> ' + "\n" +
                                ' <a href="#" class="btn btn-xs btn-flat btn-danger" data-account-id="' + obj.user.id + '" ' +
                                ' data-type-modal="User" data-account-name=" ' + obj.user.username + ' " ' +
