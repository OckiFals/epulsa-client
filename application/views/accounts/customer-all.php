 ...
 */
?>
<?php $this->load->view('header', ['title' => 'Kelola Akun Pengguna']) ?>
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active"><i class="fa fa-users"></i> Semua Pengguna</li>
            </ol>
        </section>
                        ...
                        <div class="box box-info" id="contentData">
                            <div class="box-header with-border">
                                ...
                                <div class="box-tools pull-right">
                                    <a href="<?php echo base_url('account/customer/add') ?>" class="btn btn-info btn-sm btn-flat"
                                       rel="tab">
